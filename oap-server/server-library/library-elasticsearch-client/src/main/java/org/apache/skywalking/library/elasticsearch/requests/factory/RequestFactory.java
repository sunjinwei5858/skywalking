...
import static org.apache.skywalking.library.elasticsearch.ElasticSearchVersion.OS_V1;
import static org.apache.skywalking.library.elasticsearch.ElasticSearchVersion.ES_V6_0;
import static org.apache.skywalking.library.elasticsearch.ElasticSearchVersion.ES_V7_0;
import static org.apache.skywalking.library.elasticsearch.ElasticSearchVersion.ES_V7_8;
import static org.apache.skywalking.library.elasticsearch.ElasticSearchVersion.ES_V8_0;
...
public interface RequestFactory {
    ...
    static RequestFactory of(ElasticSearchVersion version) {
        ...
        if (version.compareTo(OS_V1) >= 0) {
            return V78RequestFactory.INSTANCE;
        }

        if (version.compareTo(ES_V6_0) >= 0 && version.compareTo(ES_V7_0) < 0) {
            return V6RequestFactory.INSTANCE;
        }
        if (version.compareTo(ES_V7_0) >= 0 && version.compareTo(ES_V7_8) < 0) {
            return V7RequestFactory.INSTANCE;
        }
        if (version.compareTo(ES_V7_8) >= 0 && version.compareTo(ES_V8_0) < 0) {
            return V78RequestFactory.INSTANCE;
        }
