...
import org.apache.skywalking.library.elasticsearch.ElasticSearchClientBuilder;
...
public class ElasticSearchClient implements Client, HealthCheckable {
    ...
    public void connect() {
        ...
        try {
            ...
            final ElasticSearchClientBuilder cb =
                org.apache.skywalking.library.elasticsearch.ElasticSearchClient
                    .builder()
